...
const BookPage = () => {
  ...
  return (
    ...
    <TextField
  variant="outlined"
  sx={{ mb: 3, width: '50%',borderRadius: '50px', }} // Increased width here
  value={searchQuery}
  onChange={(e) => setSearchQuery(e.target.value)}
  placeholder="Search by book name or author" // Placeholder text here
  InputProps={{
    startAdornment: (
      <Iconify icon="eva:search-fill" sx={{ mr: 1, color: 'gray' }} />
    ),
  }}
/>
  ...
  <Stack direction="row" spacing={2} sx={{ mt: 2 }}>
    ...
    <Button
      ...
      onClick={() => {
        ...
        link.href = `http://localhost:5000${book.pdfUrl}`;
